...
// Dual-mode (IIFE + module.exports/window.*) so test/contrast.test.js can
// require it in Node; the contract test file (test/a11y-contract.test.js)
// scans the real sources instead. IIFE wrapper is load-bearing: it must not
// leak top-level consts (e.g. `api`) into the classic-script global scope.
(() => {
