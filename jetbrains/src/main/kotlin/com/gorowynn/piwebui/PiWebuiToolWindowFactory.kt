    ...
    private fun wireDiffBridge(project: Project, browser: JBCefBrowser) {
        ...
        openDiff.addHandler { json: String ->
            ...
            ApplicationManager.getApplication().invokeLater {
                ...
                val decision = DiffApprovalDialog(project, payload).open()
        ...
        // loads; only our wrapper function needs re-installing.)
        // VERIFY: JBCefBrowser.getJBCefClient().getCefClient().addLoadHandler(...)
